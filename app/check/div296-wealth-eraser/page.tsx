            ...
            <div className="flex flex-wrap items-center justify-between gap-4 rounded-2xl border border-blue-100 bg-blue-50 px-6 py-5">
              <div>
                ...
                <p className="mt-1 max-w-xl text-sm leading-relaxed text-blue-900">
                  All calculations derived from the Treasury Laws Amendment (Building a Stronger and Fairer Super System) Act as enacted <strong>10 March 2026</strong>, cross-referenced with ATO guidance. Last verified: {lastVerified}.
                </p>
              </div>
